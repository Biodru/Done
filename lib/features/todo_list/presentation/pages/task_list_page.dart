...
import 'package:done/core/presentation/widgets/no_error.dart';
import 'package:done/features/todo_list/presentation/cubit/task_list_cubit/task_list_cubit.dart';
import 'package:done/features/todo_list/presentation/widgets/task_filter_row.dart';
        ...
        child: BlocBuilder<UserContextCubit, UserContextState>(
          builder: (context, state) {
            return Builder(builder: (context) {
              ...
              return Column(
                children: [
                  TasksFilterRow(cubit: cubit, contextCubit: userContextCubit),
